...
namespace DocumentManagementSystem.UI.Controllers
{
    ...
    public class SupplierMasterController : Controller
    {
        ...
        public SupplierMasterController(IDocumentService documentService, IValidator<DocumentCreateDto> documentCreateValidator, DocumentContext context, IMapper mapper)
        {
